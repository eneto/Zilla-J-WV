...
public class QueryResult  implements java.io.Serializable {
    ...
    private com.zuora.api.object.ZObject[] records;
    ...
    public QueryResult(
           ...
           com.zuora.api.object.ZObject[] records,
           int size) {
           this.done = done;
     ...
     * @return records
     */
    public com.zuora.api.object.ZObject[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.zuora.api.object.ZObject[] records) {
        this.records = records;
    }

    public com.zuora.api.object.ZObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.zuora.api.object.ZObject _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.zuora.com/", "QueryResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("done");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "done"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("queryLocator");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "queryLocator"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("records");
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "records"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://object.api.zuora.com/", "zObject"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.zuora.com/", "size"));
