...
public class LoginFault  extends com.zuora.api.fault.ApiFault  implements java.io.Serializable {
    public LoginFault() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fault.api.zuora.com/", "LoginFault"));
    }
